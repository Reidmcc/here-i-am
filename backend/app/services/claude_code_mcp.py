...
SERVER_INSTRUCTIONS = (
    ...
    "memory; memory_find for the exact words, wherever they occur), "
    "self-authored memories (memory_save), and memory curation "
...
def get_tool_listing() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {
            "name": "memory_find",
            "description": memory_tools.MEMORY_FIND_DESCRIPTION,
            "inputSchema": _with_conversation_id(memory_tools.MEMORY_FIND_SCHEMA),
        },
        {
            "name": "declare_room",
