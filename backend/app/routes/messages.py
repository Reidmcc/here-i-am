...
async def update_message(
    ...
    if memory_service.is_configured():
        ...
        await memory_service.delete_memory(message_id, entity_id=conversation.entity_id)
...
async def delete_message(
    ...
    if memory_service.is_configured() and conversation:
        for del_id in deleted_ids:
            await memory_service.delete_memory(del_id, entity_id=conversation.entity_id)
