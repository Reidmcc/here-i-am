...
class TestThinkingSummaries:
    ...
    @pytest.mark.asyncio
    async def test_emits_thinking_events_without_polluting_content(self):
        """Reasoning is surfaced as its own events and never joins the answer."""
        events = [
            _sdk_event(
                "content_block_start",
        ...
        assert done["content_blocks"] == [{"type": "text", "text": "the answer"}]
